...
import type { DiagnosticAuditAdminRow } from '@/lib/data/diagnostic-session-types';

type DiagnosticSessionAuditTableProps = {
  readonly rows: readonly DiagnosticAuditAdminRow[];
};

const AUDIT_PAGE_SIZE = 8;
const PREVIEW_MAX_CHARS = 96;
const columnHelper = createColumnHelper<DiagnosticAuditAdminRow>();
...
export function DiagnosticSessionAuditTable(props: DiagnosticSessionAuditTableProps): ReactElement {
