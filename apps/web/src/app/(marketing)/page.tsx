...
const VALUE_PROPS: readonly { readonly title: string; readonly body: string; readonly icon: typeof Scale }[] =
  [
    {
                ...
                return (
                  <li key={item.title}>
                    <Link
                      href="/quiz"
                      className={cn(
                        'flex h-full flex-col rounded-2xl border border-border bg-card p-5 shadow-xs transition-colors',
