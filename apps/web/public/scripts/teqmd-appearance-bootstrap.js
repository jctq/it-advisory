(() => {
  ...
  const adminModeKey = "teqmd-admin-color-mode";
  const adminThemeKey = "teqmd-admin-color-theme";
  const marketingModeKey = "teqmd-marketing-color-mode";
  const marketingThemeKey = "teqmd-marketing-color-theme";
