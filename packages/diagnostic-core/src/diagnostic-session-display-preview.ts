...
export type DiagnosticSessionDisplayPreview = {
...
/**
 * Resolves list/title copy for diagnostic session rows from persisted guided diagnostic JSON and answers.
 */
export function resolveDiagnosticSessionDisplayPreview(params: {
